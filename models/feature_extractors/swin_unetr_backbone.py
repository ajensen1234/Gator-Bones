...
class SwinUNETR_backbone(nn.Module):
    """
    ...
    def __init__(
        ...
        Examples::
            ...
            >>> net = SwinUNETR_backbone(img_size=(96,96,96), in_channels=1, out_channels=4, feature_size=48)

            # for 3D 4-channel input with size (128,128,128), 3-channel output and (2,4,2,2) layers in each stage.
            >>> net = SwinUNETR_backbone(img_size=(128,128,128), in_channels=4, out_channels=3, depths=(2,4,2,2))

            # for 2D single channel input with size (96,96), 2-channel output and gradient checkpointing.
            >>> net = SwinUNETR_backbone(img_size=(96,96), in_channels=3, out_channels=2, use_checkpoint=True, spatial_dims=2)
